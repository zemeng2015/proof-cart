...
Bootstrap checks: `git diff --check` and inspection of the repository contents and Markdown links.
Application build, typecheck, tests, and demo commands do not exist yet. Add real commands with the application scaffold; do not add passing placeholder tests.
